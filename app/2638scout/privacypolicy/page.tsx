...
export const metadata = { title: "2638 Scout Privacy Policy" };

export default function Scout2638PrivacyPolicyPage() {
  return (
    <PrivacyPolicyLayout title="Privacy Policy">
      <p>Effective date: April 19, 2019</p>
      <p>
        2638 Scout (&ldquo;us&rdquo;, &ldquo;we&rdquo;, or &ldquo;our&rdquo;) operates the 2638 Scout mobile
        application (the &ldquo;Service&rdquo;).
      </p>
      <p>
        This page informs you of our policies regarding the collection, use, and
        disclosure of personal data when you use our Service and the choices you
        have associated with that data. Our Privacy Policy for 2638 Scout is
      ...
      <PolicySection heading="Information Collection And Use">
        ...
        <PolicySection heading="Types of Data Collected" level={3}>
          <PolicySection heading="Personal Data" level={4}>
            ...
            <PolicyList
              items={["First name and last name", "Cookies and Usage Data"]}
            />
          </PolicySection>
      ...
      <PolicySection heading="Use of Data">
        <p>2638 Scout uses the collected data for various purposes:</p>
        <PolicyList
          items={[
      ...
      <PolicySection heading="Transfer Of Data">
        ...
        <p>
          2638 Scout will take all steps reasonably necessary to ensure that
      ...
      <PolicySection heading="Disclosure Of Data">
        <PolicySection heading="Legal Requirements" level={3}>
          <p>
            2638 Scout may disclose your Personal Data in the good faith belief
            that such action is necessary to:
          </p>
          <PolicyList
            items={[
              "To comply with a legal obligation",
              "To protect and defend the rights or property of 2638 Scout",
      ...
      <PolicySection heading="Service Providers">
        ...
        <PolicySection heading="Analytics" level={3}>
          <p>
