...
export const metadata = { title: "FRC Parts Tools Privacy Policy" };

export default function FRCPartsToolsPrivacyPolicyPage() {
  return (
    <PrivacyPolicyLayout title="Privacy Notice">
      <p>Last updated January 24, 2020</p>
      <p>
        Thank you for choosing to be part of our community at Rebel Robotics
      ...
      <PolicySection heading="9. How Can You Contact Us About This Policy?">
        ...
        <p>
          ...
          form by clicking{" "}
          <a
            href="https://app.termly.io/notify/77b029b5-012a-4f0d-b247-a9256caf7f11"
            target="_blank"
            rel="noopener noreferrer"
          >
            here
