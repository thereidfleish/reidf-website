...
export const metadata = { title: "CEV DriverDash Privacy Policy" };

export default function CEVDriverDashPrivacyPolicyPage() {
  return (
    <PrivacyPolicyLayout title="Privacy Notice">
      <p>Last updated March 26, 2022</p>
      <p>
        This privacy notice for CEV (&ldquo;Company,&rdquo; &ldquo;we,&rdquo;
        &ldquo;us,&rdquo; or &ldquo;our&rdquo;), describes how and why we might
        collect, store, use, and/or share (&ldquo;process&rdquo;) your
        information when you use our services (&ldquo;Services&rdquo;), such as
        when you:
      </p>
      <PolicyList
        items={[
          "Download and use our mobile application (CEV DriverDash), or any other application of ours that links to this privacy notice",
      ...
      <PolicySection heading="Summary of Key Points">
        <p>
          <em>
        ...
        <p>
          ...
          information depending on how you interact with CEV and the Services,
        ...
        <p>
          ...
          available{" "}
          <a
            href="https://app.termly.io/notify/a14abff3-80ff-4934-b592-26e1f0e74e47"
            target="_blank"
        ...
        <p>
          Want to learn more about what CEV does with any information we
          ...
          <PolicyList
            items={[
              ...
              <>
                ...
                including your mobile device&apos;s bluetooth, and other
      ...
      <PolicySection heading="2. How Do We Process Your Information?">
        <p>
      ...
      <PolicySection heading="3. What Legal Bases Do We Rely On To Process Your Information?">
        <p>
      ...
      <PolicySection heading="4. When And With Whom Do We Share Your Personal Information?">
        <p>
      ...
      <PolicySection heading="5. How Long Do We Keep Your Information?">
        <p>
      ...
      <PolicySection heading="6. How Do We Keep Your Information Safe?">
        <p>
      ...
      <PolicySection heading="7. What Are Your Privacy Rights?">
        <p>
          <em>In Short:</em> In some regions, such as the European Economic Area
        ...
        <p>
          ...
          contact details provided in the section &ldquo;HOW CAN YOU CONTACT US
          ABOUT THIS NOTICE?&rdquo; below.
        </p>
        <p>
        ...
        <p>
          ...
          provided in the section &ldquo;HOW CAN YOU CONTACT US ABOUT THIS
          NOTICE?&rdquo; below.
        </p>
        <p>
      ...
      <PolicySection heading="8. Controls For Do-Not-Track Features">
        <p>
      ...
      <PolicySection heading="9. Do California Residents Have Specific Privacy Rights?">
        <p>
          <em>In Short:</em> Yes, if you are a resident of California, you are
      ...
      <PolicySection heading="10. Do We Make Updates To This Notice?">
        <p>
      ...
      <PolicySection heading="11. How Can You Contact Us About This Notice?">
        <p>
      ...
      <PolicySection heading="12. How Can You Review, Update, Or Delete The Data We Collect From You?">
        <p>
